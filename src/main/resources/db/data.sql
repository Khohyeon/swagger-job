insert into user_tb(username, password, salt, name, email, contact, role, created_at) values('ssar', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '김동석', 'ssar@nate.com', '010-1111-2222', 'user', now());
insert into user_tb(username, password, salt, name, email, contact, role, created_at) values('cos', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '최영우', 'cos@nate.com', '010-2222-3333', 'user', now());

insert into enterprise_tb(enterprise_name, password, salt, address, contact, email, sector, size, role, created_at) values('긴트', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '강남구 삼성동 75-6 수당빌딩 4층', '010-7763-4370', 'company@nate.com', '스타트업', '스타트업', 'enterprise', now());
insert into enterprise_tb(enterprise_name, password, salt, address, contact, email, sector, size, role, created_at) values('더데이비포', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '영등포구 국회대로 50길 20', '010-7763-4370', 'company@nate.com', '스타트업', '스타트업', 'enterprise', now());
insert into enterprise_tb(enterprise_name, password, salt, address, contact, email, sector, size, role, created_at) values('에이인비', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '영등포구 국회대로 50길 20', '010-7763-4370', 'company@nate.com', '스타트업', '스타트업', 'enterprise', now());
insert into enterprise_tb(enterprise_name, password, salt, address, contact, email, sector, size, role, created_at) values('신한카드', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '서울 중구 을지로 100', '010-7763-4370', 'company@nate.com', '대기업', '대기업', 'enterprise', now());
insert into enterprise_tb(enterprise_name, password, salt, address, contact, email, sector, size, role, created_at) values('피플즈리그', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '구로디지털단지역 근처', '010-7763-4370', 'company@nate.com', '스타트업', '스타트업', 'enterprise', now());
insert into enterprise_tb(enterprise_name, password, salt, address, contact, email, sector, size, role, created_at) values('포카', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '서울특별시 마포구 마포대로', '010-7763-4370', 'company@nate.com', '인력소싱', '스타트업', 'enterprise', now());
insert into enterprise_tb(enterprise_name, password, salt, address, contact, email, sector, size, role, created_at) values('세컨신드롬', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '서울전체, 서울 강서구', '010-7763-4370', 'company@nate.com', '스타트업', '스타트업', 'enterprise', now());
insert into enterprise_tb(enterprise_name, password, salt, address, contact, email, sector, size, role, created_at) values('버드코리아', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '서울.한국', '010-7763-4370', '1', '스타트업', '스타트업', 'enterprise', now());
insert into enterprise_tb(enterprise_name, password, salt, address, contact, email, sector, size, role, created_at) values('노티플러스', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '서울특별시 강남구 테헤란로37길 7, 6~7층(역삼동, 조이타워)', '010-7763-4370', 'company@nate.com', '서비스', '스타트업', 'enterprise', now());
insert into enterprise_tb(enterprise_name, password, salt, address, contact, email, sector, size, role, created_at) values('라인플러스', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '성남 분당구 황새울로360번길 42', '010-7763-4370', 'company@nate.com', '대기업', '대기업', 'enterprise', now());
insert into enterprise_tb(enterprise_name, password, salt, address, contact, email, sector, size, role, created_at) values('퓨렌스', '356067e7d02ead0e9086e3f9e9cef88e8f6ca59222cd180bbf1a6205b7b40631', '{bcrypt}$2a$10$4h5bhPEcnLEsQ7fe.1Rx5OfeEH0VLV9LE0kDb1WqwWMRsjsCptRmy', '성남 분당구 황새울로360번길 42', '010-7763-4370', 'company@nate.com', '대기업', '대기업', 'enterprise', now());
...
', '/images/gint_logo.png','2023-04-01',now());
